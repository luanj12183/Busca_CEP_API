...
<img src="Imagens.png/Interface_Dados_Registrados.png" alt= "Busca de CEP - Quando você digitar os dados corretos e clicar no botão "Avançar para Resultado", uma nova janela será exibida com os dados listados que foram encontrados através da API ViaCEP. width="400px">
